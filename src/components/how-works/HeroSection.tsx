...
const HeroSection = ({heroSectionData} : HeroSectionItems) => {  
  ...
  return (
    <div style={{
      ...
      {/* Content */}
      <div className="relative z-10 w-[55%] sm:w-[53%] pt-0 sm:pt-0 md:pt-0 lg:pt-[160px] xl:pt-[240px] ml-[7%] sm:ml-[9%]">
        <p className="headingGlobal xl:text-6xl font-semibold text-grayLight">{title1}</p>
        <p className="headingGlobal xl:text-6xl font-extrabold text-[#343434]">{title2}</p>
        <p className="headingGlobal lg:text-5xl xl:text-6xl font-extrabold mt-3 text-[#343434]">
          <span className="bg-[#343434] text-brandlight py-1 px-2">{title3}</span> {title4}
        </p>
      </div>
    </div>
  );
